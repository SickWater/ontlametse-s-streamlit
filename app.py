#importing all the app dependencies
import pandas as pd 
import numpy as np 
import sklearn
...
#loading the encoder and model object
...
#creating option list for fropdown menu
...
with b:
  st.image("banner-picture(1).jpeg", use_container_width=True)
